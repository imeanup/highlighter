    ...
    c = function(a, b, c) {
        if (a && !l.isScriptOrStyle(a) && !l.isContentEditable(a)) {
            ...
            for (var d = document.createNodeIterator(a, NodeFilter.SHOW_TEXT, function(b) {
                ...
                }, !1), g = d.nextNode(); g;) f(g, b), g = d.nextNode()
        }
    }, d = function(a) {
        a.previousSibling && a.nextSibling ? (a.previousSibling.nodeValue = a.previousSibling.nodeValue + a.innerText + a.nextSibling.nodeValue, a.nextSibling.remove()) : a.previousSibling ? a.previousSibling.nodeValue = a.previousSibling.nodeValue + a.innerText : a.nextSibling ? a.nextSibling.nodeValue = a.innerText + a.nextSibling.nodeValue : a.parentNode && a.parentNode.insertBefore(document.createTextNode(a.innerText), a), a.remove()
    }, e = function(b, c) {
        ...
        if (!f || "string" != typeof f.className || -1 == f.className.indexOf(j))
            for (var h = b.length - 1; h >= 0; h--) c = b[h], c.length < 2 || (d = a.nodeValue.toLowerCase().indexOf(c), e = d + c.length, -1 == d || /^[A-z_-]+$/.test(c) && !/^([^A-z])*$/.test(a.nodeValue.charAt(d - 1) + a.nodeValue.charAt(e)) || g(b, a, f, d, e, h))
    }, g = function(a, b, c, d, e, g) {
        var h = b.nodeValue,
            i = 0 != d ? document.createTextNode(h.slice(0, d)) : null,
            l = document.createElement("i");
        l.className = j + " " + k + (g % 6 + 1), l.innerHTML = h.slice(d, e), b.nodeValue = h.slice(e), c.insertBefore(l, b), null != i && (c.insertBefore(i, l), f(i, a)), f(b, a)
